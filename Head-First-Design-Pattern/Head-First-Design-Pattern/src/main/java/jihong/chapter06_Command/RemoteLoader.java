...
public class RemoteLoader {
    ...
    public static void main(String[] args) {
        ...
        remoteControl.setCommand(
                0, new LightOnCommand(livingRoomLight), new LightOffCommand(livingRoomLight));
        ...
        remoteControl.setCommand(
                1,
                new CeilingFanMediumCommand(livingCeilingFan),
                new CeilingFanOffCommand(livingCeilingFan));
        remoteControl.setCommand(
                2,
                new CeilingFanHighCommand(livingCeilingFan),
                new CeilingFanOffCommand(livingCeilingFan));
        ...
        System.out.println("\n\n------Macro Test------");
        Command[] partyOn = {
            new LightOnCommand(livingRoomLight), new StereoOnWithCDCommand(livingStereo)
        };
        Command[] partyOff = {
            new LightOffCommand(livingRoomLight), new StereoOffWithCDCommand(livingStereo)
        };
